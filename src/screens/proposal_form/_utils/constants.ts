...
export const subdomains = [{ name: 'starknet', grants: ['661667585afea0acb56c9f08'], isPrivate: false, isEnabled: false }, { name: 'polygon', grants: ['65eb4d301080cbb3447f4b4f'], isPrivate: true, isEnabled: false }, { name: 'axelar', grants:['661e3ca0f056dd981db4e4a5'], isPrivate: true, isEnabled: true } ]
export const subdomainProposals = [{ name: 'axelar', grants: ['661e3bf5ccf6446509d2b308', '661e3cc3f056dd981db4e6a6', '65fad2b01080cbb344dbbf24', '661e3c82f056dd981db4e293', '661e3c40ccf6446509d2c01c', '661e3ce1f056dd981db4e795', '661e3ca0f056dd981db4e4a5'] }, { name: 'ens', grants: ['6619151a3a7a91313846ed80'] }]
