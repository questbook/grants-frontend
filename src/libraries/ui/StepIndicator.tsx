...
function StepIndicator({step}: Props) {
    return (
        <Flex gap={1} alignSelf='stretch'>
            ...
            <Container borderRadius='1px' bgColor={step>1 ? 'azure.1' : 'gray.2'} height={1}></Container>
            <Container borderRadius='1px' bgColor={step>2 ? 'azure.1' : 'gray.2'} height={1}></Container>
        </Flex>
    )
}
