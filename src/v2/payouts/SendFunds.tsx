	...
	return (
		<>
			...
			<TransactionInitiatedModal
				...
				proposalUrl={isEvmChain ? getGnosisTansactionLink(safeObj?.safeAddress?.toString()!, safeObj?.chainId?.toString()!, proposalAddr) : getProposalUrl(safeObj?.safeAddress?.toString()!, proposalAddr)}
