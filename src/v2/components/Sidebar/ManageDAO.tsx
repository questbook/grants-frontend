...
function ManageDAO({ workspaces, onWorkspaceClick }: Props) {
  ...
  return workspace && workspace.id && accountData?.address ? (
    <Flex direction="column" mt={4}>
      <Flex direction="column" mx={6}>
        ...
        <Flex mt={2}>
          <Flex direction="column">
            <Text fontWeight="500" fontSize="16px" lineHeight="24px">{workspace.title}</Text>
            <Text
              fontSize="14px"
              lineHeight="16px"
              fontWeight="500"
      ...
      <Divider bg="#E0E0EC" height="1px" mt={2} my={3} />
      <Flex direction="column" ml={6}>
        <Flex display={expanded ? 'block' : 'none'} maxH="170px" w="100%">
          <Flex direction="column" overflowY="scroll" maxH="80%" w="100%">
          ...
          <Button
            ...
            lineHeight="16px"
            bg="white"
            leftIcon={<Image boxSize="20px" src="/ui_icons/new_dao.svg" />}
            _hover={{ fontWeight: 700 }}
            _active={{}}
            mx={0}
            mt={4}
		...
		{expanded && <Divider bg="#E0E0EC" height="1px" mt={6} />}
