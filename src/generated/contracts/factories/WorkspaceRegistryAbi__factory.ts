...
import type {
  ...
  WorkspaceRegistryAbiInterface,
} from "../WorkspaceRegistryAbi";
...
export class WorkspaceRegistryAbi__factory {
  ...
  static createInterface(): WorkspaceRegistryAbiInterface {
    return new utils.Interface(_abi) as WorkspaceRegistryAbiInterface;
  }
  static connect(
    address: string,
