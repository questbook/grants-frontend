		...
		en: {
			translation: {
				...
				'/explore_grants/apply' : {
					...
					'address_tooltip': '1. Wallet address on the specified network\n2. Unstoppable Domain (hyperlinked) on the specified network\n3. IDriss (hyperlinked) email, phone number or Twitter handle',
