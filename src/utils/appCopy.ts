		...
		en: {
			translation: {
				...
				'/onboarding/create-domain': {
					...
					'multisig_safe_address': 'Multisig Wallet Address',
					'multisig_safe_address_helper': 'Supported multisig wallets: Gnosis Safe, Realms',
					'looking_for_safe': 'Looking up multisig wallets with this address on different networks...',
					'safe_found' : 'Multisig wallets with this address was found on one network',
					'safes_found' : 'Multiple wallets with this address were found on multiple networks',
					...
					'program_name_title': 'What do you want to call your ecosystem growth program?',
					'program_name': 'Give it a name',
					'program_name_helper': 'Typically the name is chosen to be an area of focus for the ecosystem growth program.',
					'program_name_placeholder': 'e.g. Compound Risk Parameter Research Grants',
					'create': 'Create',
					'verify_signer': 'Please verify you’re a signer on this multisig wallet. This will ensure we don’t have impersonation.',
