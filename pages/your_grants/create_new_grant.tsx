...
import useCreateNewGrant from 'src/hooks/useCreateNewGrant'
...
function CreateNewGrant() {
	...
	const [currentStep, transactionData, blockExplorerLink, loading] = useCreateNewGrant(formData)

	console.log('currentStep create', currentStep)
