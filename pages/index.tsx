...
function BrowseGrants() {
  ...
  const allNetworkGrants = Object.keys(subgraphClients)!.map((key) =>
    useGetAllGrantsLazyQuery({ client: subgraphClients[key].client })
  );
  ...
  return (
    <Flex w="100%" ref={containerRef} direction="row" justify="center">
